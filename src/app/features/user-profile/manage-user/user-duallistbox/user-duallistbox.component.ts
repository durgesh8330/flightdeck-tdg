...
@Component({
  selector: 'sa-user-duallistbox',
  templateUrl: './user-duallistbox.component.html',
  styleUrls: ['./user-duallistbox.component.css']
})
export class UserDuallistboxComponent implements OnInit {
